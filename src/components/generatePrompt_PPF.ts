...
export function generatePrompt_PPF(variables: {
    ...
    Answer generation specifics: THINK DEEPLY ABOUT THE ANSWER. CONSIDER INTERPRETATIONS FOR EACH past/present/future CARD INDIVIDUALLY AND THEN THEIR COMBINED INTERPRETATION. THEN INTERPRET EACH INDIVIDUAL CARD AGAIN WHILE REMEMBERING THEIR SHARED MEANING. THIS IS VERY IMPORTANT SO TAKE YOUR TIME.
    FORMAT:
