...
export function generatePrompt_career(variables: {
    ...
    Answer generation specifics: THINK DEEPLY BUT VALUE SPEED TO ANSWER. GIVE CAREER ADVICE ACORDING THESE ASPECTS: WHAT ARE YOU GOOD AT, WHAT THEY LOVE, WHAT THE WORLD NEEDS, WHAT THEY CAN GET PAID FOR) AND THEN THEIR COMBINED INTERPRETATION. GIVE A READING FOR TODAY USING THE THREE CARD INTERPRETATIONS AND THEN THEIR COMBINED INTERPRETATION. MAKE IT UNIQUE, CREATIVE AND ALLOW FOR HALLUCINATIONS. THIS IS IMPORTANT.
    FORMAT:
