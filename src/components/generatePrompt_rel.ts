...
export function generatePrompt_rel(variables: {
    ...
    Answer generation specifics: THINK DEEPLY BUT VALUE SPEED TO ANSWER. CONSIDER INTERPRETATIONS FOR EACH INDIVIDUAL CARD IN THE CONTEXT OF A RELATIONSHIP AND THEN THEIR COMBINED INTERPRETATION. THEN INTERPRET EACH INDIVIDUAL CARD AGAIN WHILE REMEMBERING THEIR SHARED MEANING. THIS IS IMPORTANT.
    FORMAT:
