...
export function generatePrompt_weekly(variables: {
    ...
    Answer generation specifics: THINK DEEPLY ABOUT THE ANSWER. GIVE A READING FOR THE COMING WEEK USING THE THREE CARD INTERPRETATIONS AND THEN THEIR COMBINED INTERPRETATION. THIS IS VERY IMPORTANT SO TAKE YOUR TIME.
    FORMAT:
