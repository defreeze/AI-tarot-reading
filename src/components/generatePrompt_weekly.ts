...
export function generatePrompt_weekly(variables: {
    ...
    Answer generation specifics: THINK DEEPLY BUT VALUE SPEED TO ANSWER. GIVE A READING FOR THE COMING WEEK USING THE THREE CARD INTERPRETATIONS AND THEN THEIR COMBINED INTERPRETATION. THIS IS IMPORTANT.
    FORMAT:
