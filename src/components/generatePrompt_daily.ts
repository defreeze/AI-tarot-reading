...
export function generatePrompt_daily(variables: {
    ...
    Answer generation specifics: THINK DEEPLY ABOUT THE ANSWER. GIVE A READING FOR TODAY USING THE THREE CARD INTERPRETATIONS AND THEN THEIR COMBINED INTERPRETATION. THIS IS VERY IMPORTANT SO TAKE YOUR TIME.
    FORMAT:
